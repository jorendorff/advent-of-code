...
assert fft100(crack('80871224585914546619083218645595')) == crack('24176176')
assert fft100(crack('19617804207202209144916044189917')) == crack('73745418')
assert fft100(crack('69317163492948606335995924319873')) == crack('52432133')


def main():
    s = fft100(crack(puzzle_input()))
    eight = s[:8]
